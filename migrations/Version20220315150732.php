 ...
 */
final class Version20220315150732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, type_activity DATE NOT NULL, date DATE NOT NULL, adress_activity VARCHAR(255) NOT NULL, nb_people_max INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prestation (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, price INT NOT NULL, is_available TINYINT(1) NOT NULL, img JSON DEFAULT NULL, description VARCHAR(255) NOT NULL, nb_people_max INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stays (id INT AUTO_INCREMENT NOT NULL, type_of_stay VARCHAR(255) NOT NULL, check_in DATE NOT NULL, check_out DATE NOT NULL, adress VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE travel (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT NOT NULL, airport_departure VARCHAR(255) NOT NULL, airport_arrival VARCHAR(255) NOT NULL, date_departure VARCHAR(255) NOT NULL, date_arrival DATE NOT NULL, UNIQUE INDEX UNIQ_2D0B6BCE4A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicle_rental (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT NOT NULL, type_vehicul VARCHAR(255) NOT NULL, pick_up_date DATE DEFAULT NULL, drop_off_date DATE DEFAULT NULL, pick_up_location VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_BFC7C3AE545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE travel ADD CONSTRAINT FK_2D0B6BCE4A4A3511 FOREIGN KEY (vehicule_id) REFERENCES vehicle (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE travel DROP FOREIGN KEY FK_2D0B6BCE4A4A3511');
